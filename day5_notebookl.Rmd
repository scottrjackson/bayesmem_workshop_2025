...
# save(carmen_base_fit, file = "carmen_base_fit.RData")
# load("carmen_base_fit.RData")
...
sim_priors <- c(
  # marginal "Intercept"
  set_prior("normal(9.69, 1)", class = "Intercept"),
  # "fixed effects"
  set_prior("", class = "b", coef = "logTrial"),
  set_prior("", class = "b", coef = "GapTypeLab"),
  set_prior("", class = "b", coef = "SLxSL3"),
  set_prior("", class = "b", coef = "SLxSL3:GapTypeLab"),
  # "random effects"
  # subject-level
  set_prior("", class = "sd", coef = "Intercept", group = "SubjectID"),
  set_prior("", class = "sd", coef = "logTrial", group = "SubjectID"),
  set_prior("", class = "sd", coef = "GapTypeLab", group = "SubjectID"),
  set_prior("", class = "sd", coef = "SLxSL3", group = "SubjectID"),
  set_prior("", class = "sd", coef = "SLxSL3:GapTypeLab", group = "SubjectID"),
  # set-level
